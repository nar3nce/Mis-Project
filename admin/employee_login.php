...
<div class="container">
   <div class="modal fade" id="employee" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <form class="login-form" id="form1" name="form1" method="post" action="admin_code.php">
      <div class="login-wrap">
        <h3 class="page-header"><center>
          <h2><span class="style1"><span class="fa fa-key"> </span> Employee</span> <span class="style2">login</span></h2>
          </center>
        </h3>
